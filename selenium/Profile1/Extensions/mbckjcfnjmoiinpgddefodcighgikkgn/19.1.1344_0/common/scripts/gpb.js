 ...
 ******************************************************************************/
    AvastWRC.gpb.All.SafeShopOffer = PROTO.Message("AvastWRC.gpb.All.SafeShopOffer",{
        ...
        DeepIntegrationRule : PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.DomainInfoResponse.DeepIntegrationRule",{
        ...
        DomainInfoResponse: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.DomainInfoResponse",{
            ...
            coupon_deep_integration:    GPBD.cType(6, PROTO.repeated, function() {return AvastWRC.gpb.All.SafeShopOffer.DeepIntegrationRule; }),
            suppress_x_timeout:         GPBD.bool(7, PROTO.optional)
        }),
        /**********************************************************************/
        /* Endpoint: /offers                                                  */
        /**********************************************************************/
        ...
        OfferResponse : PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.OfferResponse",{
            ...
            offer_deep_integration:      GPBD.cType(7, PROTO.repeated, function() {return AvastWRC.gpb.All.SafeShopOffer.DeepIntegrationRule; })
        }),
        ...
        SearchCouponResponse: PROTO.Message("AvastWRC.gpb.All.SafeShopOffer.SearchCouponResponse",{            
            voucher:                GPBD.cType(1, PROTO.repeated, function(){return AvastWRC.gpb.All.SafeShopOffer.Voucher;}) 
        }),
        /**********************************************************************/
